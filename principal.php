...
<body>
    ...
    <form action="calculadora.php" method="get">
        ...
        <button type="submit">Escritura de Compra e Venda - Simples</button>
    </form>
    <form action="calculadora.php" method="get">
        <input type="hidden" name="bt-servico" value="Escritura de Compra e Venda + Alienação">
        <button type="submit">Escritura de Compra e Venda + Alienação</button>
    </form>
    <form action="calculadora.php" method="get">
